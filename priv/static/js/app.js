...
var elmContainer = document.querySelector("#elm-container");
...
if (elmContainer) _main2.default.Main.embed(elmContainer);
...
(function () {
	...
	var _user$project$Main$main = _elm_lang$virtual_dom$Native_VirtualDom.staticProgram(_elm_lang$html$Html$text('Hello from Elm inside Phoenix!'));
