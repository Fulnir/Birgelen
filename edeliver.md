...
mix edeliver deploy release to production --branch=develop

mix edeliver stop production
mix edeliver upgrade production --branch=develop --clean-deploy --force --start-deploy
...
# --verbose 
mix edeliver upgrade production --clean-deploy --branch=develop --force --start-deploy
mix edeliver start production
mix edeliver ping production
```
